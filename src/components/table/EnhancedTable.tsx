...
interface LocalEnhancedTableProps {
  numSelected: number;
  onRequestSort: (event: React.MouseEvent<unknown>, property: keyof HeadCell) => void;
...
function EnhancedTableHead({ 
  ...
  tableRows = [],
  ...props }: 
  EnhancedTableProps & LocalEnhancedTableProps) {
  ...
  const createSortHandler =
    ...
    return (
      <TableHead>
        <TableRow>
          <TableCell padding="none" style={{ padding: '0px', margin: '0' }}>
            <Checkbox
              color="primary"
...
export default function EnhancedTable({ 
  ...
  const [orderBy, setOrderBy] = React.useState<keyof HeadCell>('id');
